                        ...
                        <div class="_2-grid">
                            <div class="module">
                                <div class="module-header">
                                    <h3 class="module-heading">Schedule</h3>
                                ...
                                <div class="module-main">
                                    <div class="w-layout-grid schedule-grid">
                                        ...
                                        <div id="w-node-_2f0fd50e-3aa3-92d5-470c-1b77faf57e29-20776f55" class="schedule-div">
                                            <div>Prepare Orders</div>
                                        </div>
                                        <div id="w-node-_261407be-72fc-03e9-16d4-0a907bd37383-20776f55" class="schedue-time">
                                            <div>11 AM</div>
                                        </div>
                                        <div class="schedue-time">
                                            <div>12 PM</div>
                                        </div>
                                        <div id="w-node-_45f5184d-0aa8-d2d2-2f3e-40da124f9395-20776f55" class="schedule-div">
                                        ...
                                        <div id="w-node-_3732ae8b-67da-bb0d-f1ad-fe3531a76d29-20776f55" class="schedule-div blank"></div>
                                        <div class="schedue-time">
                                            <div>4 PM</div>
                                        </div>
                                        <div id="w-node-dafc0d92-7cfc-235b-cb73-f6faa75e5e7f-20776f55" class="schedule-div">
                                            <div>Send Orders</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="module">
                                <div class="module-header">
                                    <h3 class="module-heading">Tasks</h3>
                                    <div class="module-filters">
                                    ...
                                    <div>
                                        ...
                                        <div class="email-element">
                                            <div class="notification-top">
                                                ...
                                                <div class="email-time">12:52pm</div>
                                            </div>
                                            <p class="notification-subtitle">Your domain will expire soon</p>
                                            <p class="notification-description">Your domain “nicehats.com” is set to expire</p>
                                        </div>
                                        <div class="email-element">
                                            <div class="notification-top">
                                                <div class="notification-dot"></div>
                            ...
                            <div class="module">
                                ...
                                <div class="module-main">
                                    <div class="empty-module-insert">
                                        <img src="https://assets.website-files.com/6022ffeab6f354c9aa1eb2a2/60244fb15bbcaab0b00a05d4_Check.svg" loading="lazy" width="27" alt="" class="empty-icon"/>
                                        <div>
                                            No new <br/>tickets
                                        </div>
                                    </div>
