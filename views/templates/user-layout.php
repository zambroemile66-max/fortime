...
<html data-wf-domain="dawn-dashboard.webflow.io" data-wf-page="6024853e63955a2f6b55a25b" data-wf-site="6022ffeab6f354c9aa1eb2a2">
    <head>
        <meta charset="utf-8"/>
    ...
    <body>
        <div class="wrapper">
            <div data-collapse="all" data-animation="default" data-duration="400" role="banner" class="simple-nav w-nav">
                ...
                <a href="/fortime" class="nav-link cta margin-right w-nav-link">Back to Home</a>
                <div data-hover="" data-delay="0" class="profile-menu-dropdown w-dropdown">
                    ...
                    <nav class="profile-menu-list w-dropdown-list">
                        <a href="/fortime/logout" class="profile-menu-link w-nav-link">Log Out</a>
                    </nav>
                </div>
            </div>
            <?= $content ?>
