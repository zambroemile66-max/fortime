                            ...
                            <div class="search-field-wrapper">
                                <form action="search" class="search w-form">
                                    <div class="search-field">
                                        ...
                                        ?>
                                        <input class="search-input w-input" value="<?=$value?>" maxlength="256" name="query" placeholder="Job title or keyword" type="search" id="search" required=""/>
                                    </div>
                            ...
                            <div class="search-field-wrapper">
                                <div class="search-field">
                                    ...
                                    <div class="form-block w-form">
                                        <form id="email-form-4" name="email-form-4" data-name="Email Form 4" method="get" class="form" data-wf-page-id="6481405b618c99bec1636443" data-wf-element-id="1da56800-fe78-e6bc-4193-6a651805d55a">
